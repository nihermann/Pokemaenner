...
path_shapes = os.path.join(os.getcwd(), "categorical_data", "shape_by_csv.csv")
path_stats = os.path.join(os.getcwd(), "categorical_data", "pokedex_(Update_05.20) - Kopie.csv")
path_image_data = os.path.join(os.getcwd(), "data", "all_data - Kopie")
    ...
    for pokemon in pokemon_names:
        try:
            if pokemon.lower() in image.lower():
                ...
                shutil.move(os.path.join(path_image_data, "pokemaenner_images", image), os.path.join(path_image_data,
                                                                                                     shape, image))
...
if len(images_names) == 0: os.rmdir(os.path.join(path_image_data, "pokemaenner_images"))